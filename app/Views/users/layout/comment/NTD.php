                ...
                <form action="" id="form_cmt" method="post">
                    ...
                    <div class="row border">
                        ...
                        <div class="col-6">
                            <h5>Chức vụ</h5>
                            <div class="form-group">
                                <input type="text" class="form-control" id="chucvu" name="data_info[chucvu]">
                                <p id="message"></p>
                            </div>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <h5>Số điện thoại</h5>
                            <div class="form-group">
                                <input type="text" class="form-control" id="phone" name="data_info[sodienthoai]">
                                <p id="message"></p>
                            </div>
                        </div>
                        <div class="col-6">
                            <h5>Email</h5>
                            <div class="form-group">
                                <input type="text" class="form-control" id="email" name="data_info[email]">
                                <p id="message"></p>
                            </div>
                        </div>
                    </div>
                    <div class="row ">
                            ...
                            <div class="col-12 border p-3">
                                ...
                                <?php foreach($loaihinh as $key => $val){?>
                                    <div class="col-3 mb-3 fom-group">
                                        <input type="radio" class="loaihinh" name="data_info[loaihinh]" value="<?= $val['id'] ?>"> <?= $val['name'] ?>
                                        <p id="message"></p>
                                    </div>
                                <?php } ?>
                                </div>
                        ...
                        <?php } ?>
                        <?php if(isset($hoatdong) && $hoatdong !=NULL){?>
                            <div class="col-12 border p-3">
                                <h5>Lĩnh vực hoạt động của quý cơ quan</h5>
                                    <div class="row fom-group">
                                    <?php foreach($hoatdong as $key => $val){?>
                                        <div class="col-6 mb-3">
                                            <input type="radio"  name="data_info[hoatdong]" value="<?= $val['id'] ?>"> <?= $val['name'] ?>
                                        </div>
                                    <?php } ?>
                                </div>
                            </div>
                                ...
                                <?php foreach($vitri as $key => $val){?>
                                    <div class="col-6">
                                        <div class="form-group m-2">
                                            <input type="radio"  name="data_info[posi]" value="<?= $val['id'] ?>"> <?= $val['name'] ?>
                                        </div>
                                    </div>
                                <?php } ?>
                                </div>
                        ...
                        <?php } ?>
                        <div class="col-12 border p-3">
                            <h4>Số lượng cựu sinh viên tại quý cơ quan: <input type="text" name="data_info[number_sv]"> </h4>
                        </div>
                        <?php if(isset($phamvi) && $phamvi !=NULL){?>
                            <div class="col-12 border p-3">
                                ...
                                <?php foreach($phamvi as $key => $val){?>
                                    <div class="col-4">
                                        <input type="radio"value="<?= $val['id'] ?>" name="data_info[each_data]"> <?= $val['name'] ?>
                                    </div>
                                <?php } ?>
                                </div>
                            </div>
                        ...
                        <div class="col-12 border p-3">
                            ...
                            <?php foreach($nganhhoc as $key => $val){?>
                                <div class="col-6">
                                    <input type="checkbox" name="data_nganh[]" value="<?= $val['id'] ?>"> <?= $val['name'] ?>
                                </div>
                            <?php } ?>
                            </div>
                        </div>
                        ...
                        <div class="row ">
                            <?php $i = 1; if(isset($content) && $content != NULL){?>
                                ...
                                <div class="col-12 border p-3" id="data">
                                    <h5 class="text-danger"><?= $i.' '.$val['name_cer'] ?></h5>
                                    <?php if($val['content'] && $val['content'] !=NULL ) {?>
                                        <?php $i_2 = 1; foreach($val['content'] as $key_ct => $val_ct){?>
                                            <p id="<?= $val_ct['id'] ?>" style="font-weight:bold;"  class="text-dark data"><?= $i_2.' '.$val_ct['content'] ?></p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 border p-3">
                                ...
                                <div class="row">
                                    <?php foreach($nganhhoc as $key => $val){?>
                                        <div class="col-5 m-3">
                                                <input type="radio" name="data_info[data_tuyendung]" value="<?= $val['id'] ?>"> <?= $val['name'] ?>
                                            </div>
                                    <?php } ?>
                                </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <?php $i = 1; if(isset($datas) && $datas != NULL){?>
                                    <?php foreach($datas as $key => $val){ ?>
                                    <div class="col-12 border p-3" id="data">
                                        <h5><?= $val['tieuchi'] ?></h5>
                                        <?php if($val['child'] && $val['child'] !=NULL ) {?>
                                            <?php $i =1; foreach($val['child'] as $key_ct => $val_ct){?>
                                                <p id="<?= $val_ct['id'] ?>" style="font-weight:bold;"  class="text-dark data"><?= $i.' '.$val_ct['tieuchi'] ?></p>
                                                <div class="form-group mt-0 mb-5" >
                                                    ...
                                                    <input type="radio" data-check="<?= $val_ct['id'] ?>" class="noidung" name="ck<?= $val_ct['id'] ?>" value="1"> Kém
                                                    <input type="radio" data-check="<?= $val_ct['id'] ?>" class="noidung" name="ck<?= $val_ct['id'] ?>" value ="2"> Yếu
                                                    <input type="radio" data-check="<?= $val_ct['id'] ?>" class="noidung" name="ck<?= $val_ct['id'] ?>" value ="3"> Trung bình
                                                    <input type="radio" data-check="<?= $val_ct['id'] ?>"  class="noidung" name="ck<?= $val_ct['id'] ?>" value = "4"> Khá
                                                    <input type="radio" data-check="<?= $val_ct['id'] ?>"  class="noidung" name="ck<?= $val_ct['id'] ?>" value = "5"> Tốt
                                                    <p id="message"></p>
                                                </div>
                                            <?php $i++; } ?>
                                        <?php } ?>
                        ...
                        <?php if(isset($mucdo) && $mucdo !=NULL){?>
                            <div class="row ">
                                ...
                                <?php foreach($mucdo as $key => $val){ ?>
                                    <div class="col-12 border p-3">
                                        <input type="radio" name="data_info[dapung]"  value="<?= $val['id'] ?>"> <?= $val['name'] ?>
                                    </div>
                                <?php } ?>
                            </div>
                        <?php } ?>
